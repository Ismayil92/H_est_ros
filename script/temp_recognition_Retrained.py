...
def checkStatus(croppedSymbol): #finding contour pixels
    global status
...
def callback_coordinates(data):
    ...
    rh1 = [int(DigitCoordinates.firsttempupleft[0]), int(DigitCoordinates.firsttempupleft[1]), int(DigitCoordinates.firsttempbottomleft[1]), int(DigitCoordinates.firsttempupright[0])]
    rh2 = [int(DigitCoordinates.secondtempupleft[0]), int(DigitCoordinates.secondtempupleft[1]), int(DigitCoordinates.secondtempbottomleft[1]), int(DigitCoordinates.secondtempupright[0])]
...
if __name__ == "__main__":
    ...
    #ROS PUBLISHER
    pub = rospy.Publisher('temp_info', screen, queue_size = 1)
    rospy.init_node('temp_info', anonymous = True)
    msg = screen()
